function evaluateBubble(result, bubbleType::Type{Q}, discretization, externalParams::ExternalInput{T, X, P}) where {Q,T,X,P}
    # TODO:
    # write the function
    return 1.0
end
...
function generateAll(genParams::GenerateParameter{T,I}, bubble::Type, extParams) where {T,I}
    start_time = now()
